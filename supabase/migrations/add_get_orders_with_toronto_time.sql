-- Fonction pour récupérer les commandes avec la date convertie en heure America/Toronto
-- Cette fonction sera utilisée pour les analytics afin d'avoir la date correcte en Toronto
